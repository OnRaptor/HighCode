...
namespace HighCode.Presentation.Data.Migrations
{
    ...
    [Migration("20240403120459_CodeTaskSolution updates")]
    partial class CodeTaskSolutionupdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HighCode.Presentation.Data.Models.Comment", b =>
                {
                    ...
                    b.HasOne("HighCode.Presentation.Data.Models.CodeTaskSolution", "RelatedTask")
                        .WithMany("Comments")
                        .HasForeignKey("RelatedTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
